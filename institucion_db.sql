...
CREATE TABLE `clase` (
  ...
  `usuIdEstudiante` int NOT NULL,
  PRIMARY KEY (`claseId`),
  UNIQUE KEY `ClaseId_UNIQUE` (`claseId`),
  UNIQUE KEY `ClaseDescripcion_UNIQUE` (`claseDescripcion`),
  KEY `usuIdProfesor_idx` (`usuIdProfe`),
  KEY `usuIdEstudiante_idx` (`usuIdEstudiante`),
  CONSTRAINT `usuIdEstudiante` FOREIGN KEY (`usuIdEstudiante`) REFERENCES `usuario` (`usuId`),
...
INSERT INTO `usuario` VALUES (1,'pedro@gmail.com','paquito123','Lopez','Pedro','CC',1028549878,3205894471,'Activo',3);
...
-- Dump completed on 2024-10-02 15:13:19
