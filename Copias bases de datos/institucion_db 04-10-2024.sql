...
CREATE TABLE `materia` (
  ...
  KEY `profesorMateriaId_fk_idx` (`usuIdProfesor`),
  CONSTRAINT `profesorMateria_fk` FOREIGN KEY (`usuIdProfesor`) REFERENCES `profesor` (`profId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-03 23:40:08
